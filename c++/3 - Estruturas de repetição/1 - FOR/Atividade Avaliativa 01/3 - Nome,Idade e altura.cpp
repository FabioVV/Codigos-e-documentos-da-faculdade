...
main(){
	...
	string novomaisnome;
	    ...
	    cout<<"Digite o nome da pessoa número "<<"1"<<"º: ";
		cin >> nome;
		
		cout<<"Digite a idade da pessoa número "<<"1"<<"º: ";
		cin >> idade;
		
		cout<<"Digite a altura da pessoa número "<<"1"<<"º: ";
		cin >> altura;
		cout<<""<<endl;
		
	
	for(i; i < 2; i++){
		cout<<"Digite o nome da pessoa número "<<i+2<<"º: ";
		cin >> nome;
		
		cout<<"Digite a idade da pessoa número "<<i+2<<"º: ";
		cin >> idade;
		
		cout<<"Digite a altura da pessoa número "<<i+2<<"º: ";
		cin >> altura;
